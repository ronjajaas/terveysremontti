...
<head>
    ...
    <title><?= $row["firstName"] .' '. $row["lastName"] ?> - Terveysremontti</title>
</head>
...
<div class="profiili container">
	<div class="row">
		<div class="col-md-12">
			<h1><?= $row["firstName"] .' '. $row["lastName"] ?> <span class="text-muted"><i class="fa fa-unlock-alt"></i> <a name="logout" href="logout.php">Kirjaudu ulos</a></span></h1></div>
		<div class="col-md-3">
			<img src="kuvat/profile.png" class="img-thumbnail" alt="Responsive image"><br><p class="text-center"><a href="kuva.php">Vaihda profiilikuva</a></p>
		</div>
		<div class="col-md-9">
